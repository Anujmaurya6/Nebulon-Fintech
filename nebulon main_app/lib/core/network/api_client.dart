...
class ApiClient {
  ...
  static final StreamController<void> _logoutTriggerController = StreamController<void>.broadcast();
  ...
  Future<Map<String, dynamic>> get(String path, {Map<String, dynamic>? queryParams}) async {
    try {
      final response = await _retryRequest(() => dio.get(path, queryParameters: queryParams));
  ...
  Future<Map<String, dynamic>> patch(String path, {dynamic data, Map<String, dynamic>? queryParams}) async {
    try {
      final response = await _retryRequest(() => dio.patch(path, data: data, queryParameters: queryParams));
      return {'data': response.data, 'error': null};
    } on DioException catch (e) {
      return {'data': null, 'error': _extractError(e)};
    }
  ...
  Future<Map<String, dynamic>> delete(String path, {Map<String, dynamic>? queryParams}) async {
    try {
      final response = await _retryRequest(() => dio.delete(path, queryParameters: queryParams));
      return {'data': response.data, 'error': null};
    } on DioException catch (e) {
      return {'data': null, 'error': _extractError(e)};
    }
  ...
  String _extractError(DioException e) {
    ...
    if (e.type == DioExceptionType.connectionTimeout) return 'Connection timed out. Please check your internet.';
